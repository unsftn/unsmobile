...
public class DormitoriesActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        nLlist = db.getNotableLocationsByType(NotableLocation.TYPE_DORMITORY);
        ...
        // novi sad display
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(45.2451469,19.8384839), 14));
    }
}
